    ...
    onAdd() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.form.value.name == "" ||
                ...
                console.log(user);
                try {
                    let ExistOrNot = yield this.mainService.post(JSON.stringify(user), "/registration");
                    if (ExistOrNot != "exist") {
...
AddRoleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-role.component.css */ "./src/app/add-role/add-role.component.css")).default]
    })
], AddRoleComponent);
...
let AddComponent = class AddComponent {
    ...
    ngOnInit() {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            number: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](``, [
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
    ...
    onAdd() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if ((this.form.value.name == "") || (this.form.value.artikul == "") || (this.filename == "") || (this.form.value.price == "") || (this.form.value.weight == "") || (this.form.value.description == "") || (this.form.value.num == "") || (this.form.value.ingredients == "")) {
                ...
                try {
                    ;
                    let result = yield this.mainService.post(JSON.stringify(product), "/add");
                    let obj = {
                        idproduct: result,
                        operation: "+",
                        different: this.form.value.number,
                    };
                    let res = yield this.mainService.post(JSON.stringify(obj), `/history`);
                }
                catch (err) {
                    console.log(err);
                }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminCommentComponent", function() { return AdminCommentComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let AdminCommentComponent = class AdminCommentComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.loading = true;
            try {
                let result = yield this.mainService.get("/all-comments");
                ...
                if (typeof result !== "undefined") {
                    ...
                    for (const one in result) {
                        let time = `${moment__WEBPACK_IMPORTED_MODULE_3__(result[one].datetime).format("LL")}`;
                        let result1 = yield this.mainService.get(`/user/${result[one].iduser}`);
                        let comment = {
    ...
    onDelete(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let result = yield this.mainService.delete(`/comments/${id}`);
            }
            catch (error) {
                console.log(error);
            }
...
AdminCommentComponent.ctorParameters = () => [
    { type: _shared_services_main_service__WEBPACK_IMPORTED_MODULE_2__["MainService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
AdminCommentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-admin-comment",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-comment.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-comment/admin-comment.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-comment.component.css */ "./src/app/admin-comment/admin-comment.component.css")).default]
    })
...
let AdminComponent = class AdminComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let resultSales;
            try {
                resultFavor = yield this.mainService.get(`/statistic/favor`);
                ...
                //
                resultComment = yield this.mainService.get(`/statistic/comments`);
                console.log(resultComment);
                for (const one of resultComment) {
                    this.datasetsComment.push(one.commentcount);
                    this.labelsComment.push(one.name);
                }
                resultSales = yield this.mainService.get(`/statistic/sales`);
...
/* harmony import */ var _authorization_authorization_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./authorization/authorization.component */ "./src/app/authorization/authorization.component.ts");
/* harmony import */ var _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./favourite/favourite.component */ "./src/app/favourite/favourite.component.ts");
/* harmony import */ var _add_role_add_role_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./add-role/add-role.component */ "./src/app/add-role/add-role.component.ts");
...
/* harmony import */ var _admin_comment_admin_comment_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./admin-comment/admin-comment.component */ "./src/app/admin-comment/admin-comment.component.ts");
/* harmony import */ var _old_delete_old_delete_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./old-delete/old-delete.component */ "./src/app/old-delete/old-delete.component.ts");
/* harmony import */ var _route_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./route.guard */ "./src/app/route.guard.ts");
...
const routes = [
    ...
    { path: "favour", component: _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_8__["FavouriteComponent"] },
    {
        path: "registration",
    ...
    { path: "add", component: _add_add_component__WEBPACK_IMPORTED_MODULE_4__["AddComponent"], canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]] },
    { path: "products/:id", component: _view_view_component__WEBPACK_IMPORTED_MODULE_5__["ViewComponent"] },
    { path: "add-role", component: _add_role_add_role_component__WEBPACK_IMPORTED_MODULE_9__["AddRoleComponent"], canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]] },
    {
        path: "list-user",
        component: _list_user_list_user_component__WEBPACK_IMPORTED_MODULE_10__["ListUserComponent"],
        canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]],
    },
    { path: "dashboard", component: _admin_admin_component__WEBPACK_IMPORTED_MODULE_11__["AdminComponent"], canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]] },
    {
        path: "admin-comment",
        component: _admin_comment_admin_comment_component__WEBPACK_IMPORTED_MODULE_12__["AdminCommentComponent"],
        canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]],
    },
    { path: "archive", component: _old_delete_old_delete_component__WEBPACK_IMPORTED_MODULE_13__["OldDeleteComponent"], canActivate: [_route_guard__WEBPACK_IMPORTED_MODULE_14__["RouteGuard"]] },
];
...
/* harmony import */ var angular_file_uploader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! angular-file-uploader */ "./node_modules/angular-file-uploader/fesm2015/angular-file-uploader.js");
...
/* harmony import */ var _authorization_authorization_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./authorization/authorization.component */ "./src/app/authorization/authorization.component.ts");
...
/* harmony import */ var _add_role_add_role_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./add-role/add-role.component */ "./src/app/add-role/add-role.component.ts");
/* harmony import */ var _list_user_list_user_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./list-user/list-user.component */ "./src/app/list-user/list-user.component.ts");
...
/* harmony import */ var _shared_pipes_mypipe_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./shared/pipes/mypipe.pipe */ "./src/app/shared/pipes/mypipe.pipe.ts");
...
/* harmony import */ var _admin_comment_admin_comment_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./admin-comment/admin-comment.component */ "./src/app/admin-comment/admin-comment.component.ts");
...
/* harmony import */ var _old_delete_old_delete_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./old-delete/old-delete.component */ "./src/app/old-delete/old-delete.component.ts");
/* harmony import */ var _route_guard__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./route.guard */ "./src/app/route.guard.ts");
/* harmony import */ var _route_error_handler__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./route-error-handler */ "./src/app/route-error-handler.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _authorization_authorization_component__WEBPACK_IMPORTED_MODULE_15__["AuthorizationComponent"],
            _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_16__["FavouriteComponent"],
            _add_role_add_role_component__WEBPACK_IMPORTED_MODULE_17__["AddRoleComponent"],
            _list_user_list_user_component__WEBPACK_IMPORTED_MODULE_18__["ListUserComponent"],
            _comments_comments_component__WEBPACK_IMPORTED_MODULE_19__["CommentsComponent"],
            _shared_pipes_mypipe_pipe__WEBPACK_IMPORTED_MODULE_20__["MypipePipe"],
            _admin_admin_component__WEBPACK_IMPORTED_MODULE_21__["AdminComponent"],
            _admin_comment_admin_comment_component__WEBPACK_IMPORTED_MODULE_22__["AdminCommentComponent"],
            _old_delete_old_delete_component__WEBPACK_IMPORTED_MODULE_24__["OldDeleteComponent"],
        ],
        imports: [
    ...
    onLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if ((this.form.value.login == "") || (this.form.value.password == "")) {
                ...
                try {
                    let ExistOrNot = yield this.api.post(JSON.stringify(infoAboutUser), "/login");
                    this.form.reset();
...
AuthorizationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./authorization.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/authorization/authorization.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./authorization.component.css */ "./src/app/authorization/authorization.component.css")).default]
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_services_main_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/services/main.service */ "./src/app/shared/services/main.service.ts");
/* harmony import */ var _shared_models_comm_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/models/comm.model */ "./src/app/shared/models/comm.model.ts");
...
let CommentsComponent = class CommentsComponent {
    constructor(router, activateRouter, mainService) {
        this.router = router;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                let result = yield this.mainService.get(`/comments/${this.id}`);
                ...
                if (typeof result[0] !== "undefined") {
                    ...
                    for (const one in result) {
                        ...
                        let time = `${moment__WEBPACK_IMPORTED_MODULE_6__(result[one].datetime).format("LL")}`;
    ...
    onAdd() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.form.value.comment == "") {
                ...
                console.log(comment);
                try {
                    let result = yield this.mainService.post(JSON.stringify(comment), "/comments");
                    console.log(result);
                    let name = result[0].name;
                    if (localStorage.getItem("id") == result[0].iduser) {
                        name = `${result[0].name} (Вы)`;
                    }
                    let time = `${moment__WEBPACK_IMPORTED_MODULE_6__(result[0].datetime).format("LL")}`;
                    // console.log("hello world", time);
...
let FavouriteComponent = class FavouriteComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.loading = true;
            try {
                let result = yield this.mainService.get(`/favour/${localStorage.getItem("id")}`);
                if (Object.keys(result).length == 0) {
                    console.log("пуст");
                    result = undefined;
                }
...
FavouriteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./favourite.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/favourite/favourite.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./favourite.component.css */ "./src/app/favourite/favourite.component.css")).default]
    })
], FavouriteComponent);
...
let ItemComponent = class ItemComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (localStorage.getItem("id") !== null) {
                let response;
                try {
                    response = yield this.mainService.get(`/favour/${localStorage.getItem("id")}`);
                    let all = response;
                    console.log(all);
    ...
    onDelete(item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let result = yield this.mainService.delete(`/delete/${item.id}`);
                let result2 = yield this.mainService.post(JSON.stringify(item), "/archive");
            }
            catch (error) {
                console.log(error);
            }
    ...
    deleteFavourite() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                ...
                let result = yield this.mainService
                    .delete(`/favour/${localStorage.getItem("id")}/${this.item.id}`);
                this.heart = false;
            }
            catch (error) {
                console.log(error);
    ...
    addFavourite() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                ...
                let result = yield this.mainService.post(obj, `/favour`);
                this.heart = true;
            }
            catch (error) {
                console.log(error);
...
], ItemComponent.prototype, "del", void 0);
...
let ListUserComponent = class ListUserComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                let result = yield this.mainService.get("/users");
                if (typeof result !== "undefined") {
                    console.log(result);
                    for (const one in result) {
                        let name = result[one].name;
    ...
    onDelete(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let result = yield this.mainService.delete(`/users/${id}`);
            }
            catch (error) {
                console.log(error);
            }
...
ListUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/list-user/list-user.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list-user.component.css */ "./src/app/list-user/list-user.component.css")).default]
    })
], ListUserComponent);
...
let ListComponent = class ListComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.loading = true;
            try {
                let result = yield this.mainService.get("/products");
                if (typeof result[0] !== "undefined") {
                    this.notfound = false;
                    console.log(result);
                    for (const one in result) {
    ...
    search(items, searchString) {
        if (!Object(util__WEBPACK_IMPORTED_MODULE_4__["isNullOrUndefined"])(items) && searchString.trim().length > 0) {
            let newArr = items.filter((item) => item.name.toLowerCase().indexOf(searchString.toLowerCase()) === 0 ||
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OldDeleteComponent", function() { return OldDeleteComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _shared_services_main_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/services/main.service */ "./src/app/shared/services/main.service.ts");
...
let OldDeleteComponent = class OldDeleteComponent {
    constructor(router, mainService) {
        this.router = router;
        this.mainService = mainService;
        this.demonstrate = true;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.loading = true;
            try {
                let result = yield this.mainService.get("/archive");
                if (typeof result[0] !== "undefined") {
                    this.notfound = false;
                    console.log(result);
                    for (const one in result) {
    ...
    onDelete(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let result = yield this.mainService.delete(`/archive/${id}`);
            }
            catch (error) {
                console.log(error);
            }
...
OldDeleteComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_services_main_service__WEBPACK_IMPORTED_MODULE_3__["MainService"] }
];
OldDeleteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-old-delete",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./old-delete.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/old-delete/old-delete.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./old-delete.component.css */ "./src/app/old-delete/old-delete.component.css")).default]
    })
], OldDeleteComponent);
    ...
    onRegistr() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.form.value.login == "" ||
                ...
                console.log(infoAboutUser);
                try {
                    let ExistOrNot = yield this.api.post(JSON.stringify(infoAboutUser), "/registration");
                    this.form.reset();
                    if (ExistOrNot != "exist") {
                        console.log(ExistOrNot);
                        this.user.id = ExistOrNot[0].id;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RouteErrorHandler", function() { return RouteErrorHandler; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let RouteErrorHandler = class RouteErrorHandler {
...
RouteErrorHandler.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] }
];
RouteErrorHandler = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
class Comm {
    constructor(id, iduser, name, idproduct, text, date) {
        this.id = id;
        this.iduser = iduser;
        this.name = name;
...
class Product {
    constructor(id, name, filename, artikul, number, price, weight, description, ingredients) {
        this.id = id;
        this.name = name;
...
let MypipePipe = class MypipePipe {
    transform(items, searchString) {
...
let ViewComponent = class ViewComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                this.res = yield this.mainService.post(JSON.stringify(this.item), "/onecard");
            }
            catch (error) {
                console.log(error);
            }
            ...
            if (this.product.id != "") {
                ...
                this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
                    ...
                    number: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](`${this.product.number}`, [
                        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(0),
                    ]),
                });
    ...
    onDelete() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let result = yield this.mainService.delete(`/delete/${this.product.id}`);
                let result2 = yield this.mainService.post(JSON.stringify(this.product), "/archive");
            }
            catch (error) {
                console.log(error);
            }
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.editOrNot) {
                ...
                try {
                    ...
                    let res = yield this.mainService.put(JSON.stringify(newProduct), `/products/${this.product.id}`);
                }
                catch (error) {
                    console.log(error);
                }
    ...
    deleteFavourite() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                console.log("Отправили запрос на удаление статьи из избранного");
                let result = yield this.mainService.delete(`/favour/${localStorage.getItem("id")}/${this.product.id}`);
                this.heart = false;
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ViewComponent.prototype, "del", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\dbely\OneDrive\Рабочий стол\Программная инженерия\project\src\main.ts */"./src/main.ts");
